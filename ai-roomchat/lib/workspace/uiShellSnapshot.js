...
// -----------------------------------------------
// 이 모듈은 워크스페이스 파일 맵에서 텍스트 런타임에 필요한
// 핵심 파일들을 추려 rank_game_workspaces.* 필드 형태로
// 변환하는 유틸리티를 제공한다.
//
// - /template.json                → template
// - /graph/prompt-graph.json     → graph
// - /game/runtime.config.json    → runtime_config
// - /game/hooks/automation.js    → hooks_source
// - /game/ui.shell.json          → ui_shell (선택)
