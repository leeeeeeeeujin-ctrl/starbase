...
useEffect(() => {
  // ... initialization code ...
    ...
    registerCharacterVariables, loadGameTemplate])  // ❌ Line 149
...
useEffect(() => {
  // ...
    ...
    registerCharacterVariables, loadGameTemplate])
...
- [ ] QA 리드: __________________
- [ ] 아키텍트: __________________
- [ ] 프로덕트 매니저: __________________
...
*본 보고서는 자동화된 분석 도구와 수동 코드 리뷰를 통해 작성되었습니다.*
