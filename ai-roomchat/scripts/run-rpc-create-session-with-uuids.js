// run-rpc-create-session-with-uuids.js
// Similar to run-rpc-create-session.js but uses real UUID participant_ids
// Usage: set SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY in env, then run
//   node run-rpc-create-session-with-uuids.js
...
async function main() {
  try {
    ...
    // 3) call finalize_rank_session_outcome RPC with real UUIDs
