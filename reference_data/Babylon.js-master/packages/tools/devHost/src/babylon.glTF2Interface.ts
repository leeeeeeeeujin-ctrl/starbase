 ...
 */
export const enum AccessorComponentType {
    /**
     * Byte
     */
    BYTE = 5120,
 ...
 */
export const enum AnimationChannelTargetPath {
    /**
     * Translation
     */
 ...
 */
export const enum AnimationSamplerInterpolation {
    /**
 ...
 */
export const enum MaterialAlphaMode {
    /**
...
/** @internal */
export const enum KHRLightsPunctual_LightType {
...
/** @internal */
export const enum IMSFTAudioEmitter_DistanceModel {
    linear = "linear",
    inverse = "inverse",
...
/** @internal */
export const enum IMSFTAudioEmitter_AudioMimeType {
    WAV = "audio/wav",
}
...
/** @internal */
export const enum IMSFTAudioEmitter_AnimationEventAction {
    play = "play",
    pause = "pause",
    stop = "stop",
}
