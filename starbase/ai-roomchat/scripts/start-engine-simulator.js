...
function collectExpectations(slotLayout = [], matchingMetadata = {}) {
  ...
  if (matchingMetadata.heroMap && typeof matchingMetadata.heroMap === 'object') {
    const entries = matchingMetadata.heroMap instanceof Map
...
function main() {
  ...
  console.log(`Assignments: ${Array.isArray(matchingMetadata.assignments) ? matchingMetadata.assignments.length : 0}`)
