  ...
  return (
    <div style={styles.listBox}>
      ...
      {!loading && rows.length === 0 && (
        <div style={styles.emptyState}>조건에 맞는 게임이 없습니다.</div>
      )}
      {rows.map(game => {
        ...
        return (
          <button
            ...
            style={{
              ...styles.gameRow,
              ...(active ? styles.gameRowActive : styles.gameRowInactive),
            }}
          >
            <div style={styles.gameThumb}>
              {game.image_url ? (
                <img src={game.image_url} alt="" style={styles.gameThumbImage} />
              ) : null}
            </div>
