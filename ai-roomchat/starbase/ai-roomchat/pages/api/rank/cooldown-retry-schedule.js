...
export default async function handler(req, res) {
  ...
  const cooldownIdParam = pickStringParam(req.query.cooldownId) || pickStringParam(req.query.id);
  const keyHashParam = pickStringParam(req.query.keyHash) || pickStringParam(req.query.hashedKey);
