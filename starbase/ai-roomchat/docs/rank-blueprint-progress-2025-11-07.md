...
- **오디오 이벤트 관리자 패널**: `/api/admin/audio-events`가 Owner/프로필/히어로/이벤트 유형·검색어 필터와 CSV 내보내기를 처리하고, 관리자 포털의 `AudioEventMonitor`가 기간 프리셋(24시간/7일/30일)과 필터 칩을 공유해 최신 로그를 즉시 검토하거나 내려받을 수 있습니다. 동일 테스트 스위트에서 응답·필터 체인·CSV를 검증했습니다.【F:pages/api/admin/audio-events.js†L1-L214】【F:components/admin/AudioEventMonitor.js†L1-L260】【F:styles/AdminPortal.module.css†L203-L516】【F:__tests__/api/admin/audio-events.test.js†L1-L213】
