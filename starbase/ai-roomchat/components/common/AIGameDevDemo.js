...
import { FlexibleGameEngine, GameFactory, GAME_STATES, SCORE_EVENTS } from '../game/FlexibleGameEngine'
...
const AIGameDevDemo = () => {
  ...
  const triggerScoreEvent = async (eventType, amount = null) => {
    ...
    try {
      const result = await gameEngine.updateScore(
        eventType, 
        amount, 
        `테스트 이벤트: ${eventType}`
      )
    ...
    <div className={styles.container}>
      ...
      <div className={styles.controlPanel}>
        ...
        <div className={styles.buttonGroup}>
          ...
          <button onClick={() => triggerScoreEvent(SCORE_EVENTS.ACHIEVEMENT)} disabled={!isConnected}>
            업적 달성
          </button>
