...
const __FORCE_VERBOSE__ =
  typeof process !== 'undefined' && process.env && process.env.DEBUG_TOOL_VERBOSE === '1';
...
export class GamepadHandler {
  ...
  constructor(options = {}) {
    ...
    try {
      this._constructedWin =
        typeof global !== 'undefined' && global && global.__TEST_WINDOW__
          ? global.__TEST_WINDOW__
  ...
  async initialize() {
    ...
    try {
      ...
      try {
        ...
        const globalWinHasMock =
          hasGlobalWin && !!(global.window.addEventListener && global.window.addEventListener.mock);
        const typeofWin = typeof window === 'undefined' ? 'undefined' : 'object';
        const windowHasMock =
          typeof window !== 'undefined' &&
          !!(window.addEventListener && window.addEventListener.mock);
        if (__SHOULD_LOG__) {
          console.log('[GamepadHandler] init globals', {
            hasGlobalWin,
            globalWinHasMock,
            typeofWin,
            windowHasMock,
      ...
      this.supportsGamepad =
        typeof navigator !== 'undefined' &&
        ('getGamepads' in navigator || 'webkitGetGamepads' in navigator);
          ...
          for (let i = 0; i < keys.length; i++) {
            try {
              ...
              const hasAddMock =
                ...
                !!candidate.addEventListener.mock;
              const hasRemoveMock =
                typeof candidate.removeEventListener === 'function' &&
                !!candidate.removeEventListener.mock;
  ...
  cleanup() {
    ...
    try {
      ...
      try {
        console.log('[GamepadHandler] cleanup debug', {
          hasWindow: !!win,
          hasGlobalWindow: !!gw,
          winRemoveType: win && typeof win.removeEventListener,
          gwRemoveType: gw && typeof gw.removeEventListener,
        });
      } catch (e) {}
      ...
      try {
        if (win) {
          try {
            console.log(
              '[GamepadHandler] win.removeEventListener details:',
              String(win.removeEventListener)
            );
          } catch (e) {}
          try {
            console.log('[GamepadHandler] win.keys:', Object.keys(win));
          } catch (e) {}
        }
        if (gw) {
          try {
            console.log(
              '[GamepadHandler] gw.removeEventListener details:',
              String(gw.removeEventListener)
            );
          } catch (e) {}
          try {
            console.log('[GamepadHandler] gw.keys:', Object.keys(gw));
          } catch (e) {}
        }
      } catch (e) {}
      ...
      if (win) {
        ...
        if (this._winRemove && this._winRef) {
          try {
            this._winRemove.call(this._winRef, 'gamepadconnected', this.handleGamepadConnected);
          } catch (e) {}
          try {
            this._winRemove.call(
              this._winRef,
              'gamepaddisconnected',
        ...
        try {
          if (typeof win.removeEventListener === 'function')
            win.removeEventListener('gamepadconnected', this.handleGamepadConnected, false);
        } catch (e) {}
        try {
          if (typeof win.removeEventListener === 'function')
            win.removeEventListener('gamepaddisconnected', this.handleGamepadDisconnected, false);
        } catch (e) {}
        try {
          const fn = win['removeEventListener'];
          if (typeof fn === 'function')
            fn.apply(win, ['gamepadconnected', this.handleGamepadConnected]);
        } catch (e) {}
        try {
          const fn2 = win['removeEventListener'];
          if (typeof fn2 === 'function')
            fn2.apply(win, ['gamepaddisconnected', this.handleGamepadDisconnected]);
        } catch (e) {}
      }
      ...
      try {
        const winCount =
          win && win.removeEventListener && win.removeEventListener.mock
            ? win.removeEventListener.mock.calls.length
            : null;
        const gwCount =
          gw && gw.removeEventListener && gw.removeEventListener.mock
            ? gw.removeEventListener.mock.calls.length
            : null;
        try {
          console.log('[GamepadHandler] cleanup mock counts', { winCount, gwCount });
        } catch (e) {}
      } catch (e) {}
      ...
      if (gw) {
        try {
          if (typeof gw.removeEventListener === 'function')
            gw.removeEventListener('gamepadconnected', this.handleGamepadConnected);
        } catch (e) {}
        try {
          if (typeof gw.removeEventListener === 'function')
            gw.removeEventListener('gamepaddisconnected', this.handleGamepadDisconnected);
        } catch (e) {}
        try {
          if (typeof gw.removeEventListener === 'function')
            gw.removeEventListener('gamepadconnected', this.handleGamepadConnected, false);
        } catch (e) {}
        try {
          if (typeof gw.removeEventListener === 'function')
            gw.removeEventListener('gamepaddisconnected', this.handleGamepadDisconnected, false);
        } catch (e) {}
        try {
          const fn3 = gw['removeEventListener'];
          if (typeof fn3 === 'function')
            fn3.apply(gw, ['gamepadconnected', this.handleGamepadConnected]);
        } catch (e) {}
        try {
          const fn4 = gw['removeEventListener'];
          if (typeof fn4 === 'function')
            fn4.apply(gw, ['gamepaddisconnected', this.handleGamepadDisconnected]);
        } catch (e) {}
      }
      ...
      try {
        if (win && typeof win.removeEventListener === 'function') {
          ...
          if (typeof fn === 'function' && fn.call) {
            try {
              fn.call(win, 'gamepadconnected', this.handleGamepadConnected);
            } catch (e) {}
            try {
              fn.call(win, 'gamepaddisconnected', this.handleGamepadDisconnected);
            } catch (e) {}
          }
        }
        if (gw && typeof gw.removeEventListener === 'function') {
          ...
          if (typeof fn2 === 'function' && fn2.call) {
            try {
              fn2.call(gw, 'gamepadconnected', this.handleGamepadConnected);
            } catch (e) {}
            try {
              fn2.call(gw, 'gamepaddisconnected', this.handleGamepadDisconnected);
            } catch (e) {}
          }
        }
      } catch (e) {}
        ...
        try {
          if (typeof global !== 'undefined' && global && global.window) {
            ...
            if (gwc && typeof gwc.removeEventListener === 'function') {
              try {
                gwc.removeEventListener('gamepadconnected', this.handleGamepadConnected);
              } catch (e) {}
              try {
                gwc.removeEventListener('gamepaddisconnected', this.handleGamepadDisconnected);
              } catch (e) {}
            }
          }
        } catch (e) {}
            ...
            Object.getOwnPropertyNames(global).forEach(key => {
              try {
                ...
                if (typeof ref === 'function' && ref.mock) {
                  try {
                    ref.call(candidate, 'gamepadconnected', this.handleGamepadConnected);
                  } catch (e) {}
                  try {
                    ref.call(candidate, 'gamepaddisconnected', this.handleGamepadDisconnected);
                  } catch (e) {}
                }
              } catch (e) {}
            });
