...
function HeroList({ loading, error, heroes, onRequestDelete, onResetError }) {
...
function DeleteHeroModal({ hero, open, deleting, onCancel, onConfirm }) {
