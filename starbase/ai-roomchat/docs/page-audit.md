...
### `pages/index.js`
- Renders a full-screen landing page with themed background, title (“천계전선”), and `AuthButton` to kick off Supabase auth flow.【F:pages/index.js†L1-L37】
- Styling is inline; no local state or side effects.
