  ...
  const renderNode = (node) => {
    ...
    switch (t) {
      ...
      case 'input': {
        ...
        return (
          <input
            ...
            style={{ padding:'8px 10px', borderRadius:8, border:'1px solid #334155', background:'#0b1220', color:'#e2e8f0', width: node.width||'100%' }}
          />
        );
      }
      case 'textarea': {
      ...
      case 'grid': {
        ...
        return (
          <div style={{ display:'grid', gridTemplateColumns: `repeat(${cols}, 1fr)`, gap: node.gap??8 }}>
