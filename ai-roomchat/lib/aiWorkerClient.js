...
function generateLocalGame(userPrompt) {
  ...
  if (keywords.includes('중세') || keywords.includes('기사') || keywords.includes('용')) {
      ...
      gameNodes: [
        {
          type: 'ai',
          template:
            '🚀 서기 2387년, 당신은 은하연방의 최정예 파일럿입니다. 외계 종족 "제론"이 지구를 침공하기 시작했고, 인류의 운명이 당신의 손에 달려있습니다.\n\n당신의 우주선 "스타호크"는 최신 장비로 무장하고 있으며, 적의 모함이 화성 궤도에 나타났다는 긴급 보고가 들어왔습니다.\n\n사령부에서 명령을 기다리고 있습니다.',
        },
        {
          type: 'user_action',
          template:
    ...
    keywords.includes('좀비') ||
    keywords.includes('생존') ||
    keywords.includes('아포칼립스')
  ) {
    gameTemplate = {
