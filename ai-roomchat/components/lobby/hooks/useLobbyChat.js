...
import { hydrateIncomingMessage, hydrateMessageList } from '../../../lib/chat/hydrateMessages';
...
export default function useLobbyChat({ heroId, onRequireAuth } = {}) {
  ...
  }, [hydrateBatch, hydrateSingle, viewer?.hero_id, viewer?.owner_id, viewer?.user_id, heroId]);
