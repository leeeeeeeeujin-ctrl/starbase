        ...
        if (this.props.globalState.runtimeMode === RuntimeMode.Frame) {
            return (
                <div id="footer" className={this.props.globalState.language === "JS" ? "background-js" : "background-ts"}>
                    <div className="links">
                        <div className="link">
                            <a href="#" onClick={() => location.reload()} title="Reload">
                                <RefreshIcon />
                            </a>
                        </div>
                        <div className="link">
                            <a target="_new" href={"https://playground.babylonjs.com/" + location.hash} title="Edit">
                                <EditIcon />
                            </a>
                        </div>
                    </div>
            ...
            <div id="footer" className={this.props.globalState.language === "JS" ? "background-js" : "background-ts"}>
                {window.innerWidth < this.props.globalState.MobileSizeTrigger && (
                    <div className="modeBar">
                        <div className="link">
                            {this.props.globalState.mobileDefaultMode === EditionMode.CodeOnly && (
                                <a onClick={() => this.switchMobileDefaultMode()} title="Switch to rendering">
                                    <RenderingOnlyIcon />
                                </a>
                            )}
                            {this.props.globalState.mobileDefaultMode === EditionMode.RenderingOnly && (
                                <a onClick={() => this.switchMobileDefaultMode()} title="Switch to code">
                                    <CodeOnlyIcon />
                                </a>
                            )}
                        </div>
                ...
                <div className="links">
                    <div className="link">
                        <a target="_new" href="https://forum.babylonjs.com/" title="Forum">
                            <ForumIcon />
                        </a>
                    </div>
                    <div className="link">
                        <a target="_new" href="https://doc.babylonjs.com" title="Documentation">
                            <DocumentationIcon />
                        </a>
                    </div>
                    <div className="link">
                        <a target="_new" href="https://doc.babylonjs.com/playground" title="Search">
                            <SearchIcon />
                        </a>
                    </div>
                </div>
