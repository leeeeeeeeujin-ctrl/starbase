...
export function buildPromptNode(slot, index) {
  ...
  return {
    ...
    data: {
      ...
      actor_scope_type: slot.actor_scope_type || 'all',
      actor_scope_value: slot.actor_scope_value || '',
      body_visibility_type: slot.body_visibility_type || 'all',
      body_visibility_value: slot.body_visibility_value || '',
      guide_visibility_type: slot.guide_visibility_type || 'all',
      guide_visibility_value: slot.guide_visibility_value || '',
