...
- **StartClient 로그 보드**: 전투 턴 로그가 요약/태그/프롬프트 프리뷰와 함께 카드화되고, AI·플레이어 히스토리가 모바일 대응 그리드로 정렬돼 운영/QA가 즉시 문맥을 확인할 수 있습니다.【F:components/rank/StartClient/LogsPanel.js†L1-L219】【F:components/rank/StartClient/LogsPanel.module.css†L1-L213】【F:components/rank/StartClient/useStartClientEngine.js†L960-L1206】
