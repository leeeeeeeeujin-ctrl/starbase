...
const REQUIRED_VARS = ['SUPABASE_ACCESS_TOKEN', 'SUPABASE_PROJECT_REF', 'SUPABASE_URL', 'SUPABASE_SERVICE_ROLE']
...
function main() {
  ...
  if (requirePagerDuty && !String(process.env.RANK_EDGE_DEPLOY_PAGERDUTY_ROUTING_KEY || '').trim()) {
