    ...
    (async () => {
      ...
      const { data } = await withTable(supabase, 'heroes', table =>
        supabase
          .from(table)
          .select(
            'id,name,image_url,background_url,description,ability1,ability2,ability3,ability4,created_at,owner_id'
          )
          .eq('owner_id', user.id)
      ...
      >
        ...
        >
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
            ...
            />
            <button onClick={onClose} style={{ padding: '8px 10px', borderRadius: 8 }}>
              닫기
            </button>
          </div>
        </div>
        ...
        >
          <button onClick={onClose} style={{ padding: '10px 14px', borderRadius: 8 }}>
            취소
          </button>
          <button
            onClick={confirm}
            ...
            style={{
              padding: '10px 14px',
              borderRadius: 8,
              background: selectedId ? '#2563eb' : '#cbd5e1',
              color: '#fff',
              fontWeight: 700,
            }}
          >
