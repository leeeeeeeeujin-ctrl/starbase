...
| 2 | 새로 적재되는 `summary_payload`·`is_visible`을 소비하도록 히스토리 UI/StartClient 구독 로직을 업데이트하고, 모바일 히스토리 패널에 요약 뱃지를 노출합니다. | 프론트 (라라) | 2025-11-18 |
| 3 | 제작기에서 세트를 저장하기 전 버전 불일치를 경고하는 Maker UX 개선안을 마련합니다. | Maker UX (도윤) | 2025-11-21 |
