    ...
    <section className={styles.panel}>
      ...
      {meta.missingTable && (
        <div className={styles.callout} role="alert">
          ...
          <p className={styles.calloutBody}>
            <code>id uuid primary key default gen_random_uuid()</code>, <code>title text</code>, <code>body text</code>,
            <code>published_at timestamptz</code>, <code>created_at timestamptz default now()</code>,
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div className={styles.actions}>
          ...
          <button type="button" className={styles.secondaryButton} onClick={load} disabled={loading || saving}>
            새로 고침
          </button>
        </div>
