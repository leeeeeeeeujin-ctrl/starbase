...
const LANDING_BACKGROUND = '/landing/celestial-frontline.svg'

export default function Home() {
  return (
    <main className="landing" style={{ backgroundImage: `url(${LANDING_BACKGROUND})` }}>
      <div className="content">
        <h1 className="title">과거의 영광 속으로</h1>
