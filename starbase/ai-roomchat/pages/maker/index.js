...
diff --git a/starbase/ai-roomchat/pages/maker/index.js b/starbase/ai-roomchat/pages/maker/index.js
index 4d66589650cbdc724951c3a327219893f5aea7fd..cbcf396dbc78d4b9dddc208d407ee101bfdedb89 100644
--- a/starbase/ai-roomchat/pages/maker/index.js
+++ b/starbase/ai-roomchat/pages/maker/index.js
@@ -1,191 +1,703 @@
...
+                            <h3 style={{ margin: 0, color: '#0f172a', fontSize: 17 }}>{row.name || '이름 없는 세트'}</h3>
+                            <button
...
+                          </div>
+                        )}
+                        <span style={{ color: '#64748b', fontSize: 12 }}>최근 업데이트: {timestamp}</span>
+                      </div>
+
